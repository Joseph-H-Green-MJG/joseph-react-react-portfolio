...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://josephgreen.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  deleteImage(imageType) {
    axios
      ...
      .then(response => {
        this.props.handeFeaturedImageDelete();
      })
      .catch(error => {
  ...
  componentWillMount() {
    if (this.props.editMode) {
      ...
      this.setState({
        ...
        content: content,
        apiUrl: `https://josephgreen.devcamp.space/portfolio/portfolio_blogs/${id}`,
        apiAction: "patch"
      });
    }
  }
